<?php
class ComputerAlli_BulkInquiry_Block_Adminhtml_Bulkinquiry_Edit_Tab_History extends Mage_Adminhtml_Block_Widget_Form
{
		protected function _prepareForm()
		{
            ...
            $form = new Varien_Data_Form();
				$this->setForm($form);
				$fieldset = $form->addFieldset("bulkinquiry_form", array("legend"=>Mage::helper("bulkinquiry")->__("Administrator History")));
