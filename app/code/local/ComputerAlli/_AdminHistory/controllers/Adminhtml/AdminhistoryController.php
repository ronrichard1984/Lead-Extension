...
class ComputerAlli_AdminHistory_Adminhtml_AdminhistoryController extends Mage_Adminhtml_Controller_Action
{
		...
		{
				$this->loadLayout()->_setActiveMenu("adminhistory/adminhistory")->_addBreadcrumb(Mage::helper("adminhtml")->__("Adminhistory  Manager"),Mage::helper("adminhtml")->__("Adminhistory Manager"));
				return $this;
		}
